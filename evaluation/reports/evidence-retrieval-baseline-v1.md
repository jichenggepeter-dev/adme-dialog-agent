...
- Python: `3.11.15`
- Retrieval: deterministic metadata-aware lexical BM25-style scoring, top 3
...
| --- | ---: | ---: | ---: | ---: |
| Overall relevant | 17 | 0.765 | 0.824 | 0.794 |
| abbreviation | 4 | 0.250 | 0.250 | 0.250 |
| direct | 4 | 1.000 | 1.000 | 1.000 |
| metadata | 4 | 1.000 | 1.000 | 1.000 |
...
| --- | --- | --- | --- | ---: |
| `direct-ddi` | direct | fda-m12-2024 | fda-m12-2024, fda-mass-balance-2024 | 1.000 |
...
| `paraphrase-food` | paraphrase | fda-food-effect-2026 | fda-dili-2009, fda-food-effect-2026 | 0.500 |
...
| `abbreviation-ddi` | abbreviation | fda-m12-2024 | fda-mass-balance-2024 | 0.000 |
...
| `metadata-m12-date` | metadata | fda-m12-2024 | fda-m12-2024, fda-renal-pk-2024 | 1.000 |
| `metadata-metabolites-year` | metadata | fda-metabolites-2016 | fda-metabolites-2016 | 1.000 |
